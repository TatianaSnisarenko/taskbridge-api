...
describe('me.service - notifications list/read', () => {
  ...
  describe('getMyNotifications', () => {
    ...
    test('handles CHAT_MESSAGE without task context (fallback branch)', async () => {
      ...
      // Should use fallback and return developerProfile
      expect(result.items[0].actor_role).toBe('developer');
    ...
    test('handles COMPLETION_REQUESTED from company (developer as recipient)', async () => {
      ...
      prismaMock.notification.findMany.mockResolvedValue([
        {
          id: 'n1',
          type: 'COMPLETION_REQUESTED',
          actorUserId: 'c1', // Company requests
          projectId: 'p1',
          taskId: 't1',
          threadId: null,
          payload: {},
      ...
      // Developer receiving notification from company
      const result = await meService.getMyNotifications({
        userId: 'd1',
        persona: 'developer',
        page: 1,
    ...
    test('handles COMPLETION_REQUESTED from developer (company as recipient)', async () => {
      ...
      prismaMock.notification.findMany.mockResolvedValue([
        {
          id: 'n1',
          type: 'COMPLETION_REQUESTED',
          actorUserId: 'd1', // Developer requests
          projectId: 'p1',
          taskId: 't1',
          threadId: null,
          payload: {},
      ...
      // Company receiving notification from developer
      const result = await meService.getMyNotifications({
        userId: 'c1', // Company is recipient
        persona: 'company',
        page: 1,
        size: 20,
      });
      ...
      prismaMock.notification.findMany.mockResolvedValue([
        {
          id: 'n1',
          type: 'TASK_DISPUTE_OPENED',
          actorUserId: 'c1', // Company owner opens
          projectId: 'p1',
          taskId: 't1',
          threadId: null,
          payload: {},
          ...
          importantAt: null,
          task: {
            ownerUserId: 'c1', // Company is owner
            title: 'Build API',
          },
          project: null,
          actor: {
